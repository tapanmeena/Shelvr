        ...
        >
          ...
          <Pressable
            style={[
              ...
              deleteFile && { backgroundColor: colors.card },
            ]}
            onPress={() => setDeleteFile(!deleteFile)}
          >
            <View style={styles.optionContent}>
              <Text style={[styles.optionTitle, { color: colors.text }]}>
                Also delete downloaded file
              </Text>
              <Text
                style={[styles.optionDescription, { color: colors.subtext }]}
              >
                {deleteFile
                  ? "The ePUB file will be permanently deleted"
                  : "The file will remain on your device"}
              </Text>
            </View>
            <View
              style={[
                styles.checkbox,
                { borderColor: deleteFile ? colors.danger : colors.border },
                deleteFile && { backgroundColor: colors.danger },
              ]}
            >
              {deleteFile && (
          ...
          {deleteFile && (
            ...
            >
              ...
              <Text style={[styles.warningText, { color: colors.danger }]}>
                This cannot be undone. You&apos;ll need to re-download the book.
              </Text>
            </View>
          )}
